...
@traceable(name="load_pdf",tags=['pdf','loader','pdf_path'],metadata={'loader' : 'PyPDFLoader'})
def load_pdf(path: str):
    loader = PyPDFLoader(path)
    return loader.load()  # list[Document]

@traceable(name="split_documents",tags=['splitting','documents'],metadata={'splitter' : "RecursiveCharacterTextSplitter"})
...
@traceable(name="build_vectorstore",tags=['embeddings','vectorstore'],metadata={'embedding_model' : "text-embedding-3-small",'vector_store' : 'FAISS'})
